<script>
    ...
    import ListaLivro from "./ListaLivro.svelte";
...
<style>
    ...
    background-image: url(https://i.pinimg.com/originals/c4/d1/e0/c4d1e083acbdb201927e50b2486283b1.png);
    opacity: 0.9;
    }
    .principal{
    font-size: 22px;
...
<main>
    <body>
        <div class="principal">
            ...
            <div class="container">
                <div class="category">
                    <img class="imagem" src="https://www.estudarfora.org.br/app/uploads/2013/10/20131029_livros_115791277-768x334.jpg" alt="Falha ao carregar" width={150} height={40}/>
                    <h3>Livros</h3>
                </div>
                <div class="category">
                    <img class="imagem" src="https://www.estudarfora.org.br/app/uploads/2013/10/20131029_livros_115791277-768x334.jpg" alt="Falha ao carregar" width={150} height={40}/>
